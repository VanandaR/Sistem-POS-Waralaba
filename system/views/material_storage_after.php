                ...
                <tbody>
                    ...
                    foreach ($dataTable as $t):
                        ...
                        <tr class="gradeA">
                            ...
                            <td><?= $t['notes']; ?></td>
                            <td>
								<a href="#myModal" data-toggle="modal" data-target="#myModal" class="edit" id="<?= $t['storage_id']; ?>"><i class="fa fa-pencil"></i> Ubah</a> |
                                <a href="<?= base_url(); ?>material/delete/<?= $t['storage_id']; ?>" onclick="return confirm('Apakah anda yakin menghapus data penting ini?');"><i class="fa fa-trash-o"></i> Hapus</a>
                            </td>
                        </tr>
                        <?php
                    endforeach;
        ...
        <div class="modal-content">
            <div class="modal-body">
            	<div id="modal_content">
					<form id="basicForm" method="POST" action="<?= base_url(); ?>material_storage_after/process" class="form-horizontal">
...
<script>
	...
	$('.edit').click(function() {
		jQuery.ajax({
			type: "POST",
			url: "<?= base_url(); ?>material_storage_after/form",
			dataType: 'JSON',
			data: {id: $(this).attr("id")},
			success: function(data) {
				$("input[name='storage_id']").val(data[0]['storage_id']);
